...
#define TASK_MM 536 /* offsetof(struct task_struct, mm) */
#define TASK_PID 664 /* offsetof(struct task_struct, pid) */
#define TASK_STACK_CANARY 672 /* offsetof(struct task_struct, stack_canary) */
#define TASK_STRUCT_SIZE 1728 /* sizeof(struct task_struct) */
...
#define THREAD_REG16 1312 /* offsetof(struct task_struct, thread.reg16) */
#define THREAD_REG17 1316 /* offsetof(struct task_struct, thread.reg17) */
#define THREAD_REG18 1320 /* offsetof(struct task_struct, thread.reg18) */
#define THREAD_REG19 1324 /* offsetof(struct task_struct, thread.reg19) */
#define THREAD_REG20 1328 /* offsetof(struct task_struct, thread.reg20) */
#define THREAD_REG21 1332 /* offsetof(struct task_struct, thread.reg21) */
#define THREAD_REG22 1336 /* offsetof(struct task_struct, thread.reg22) */
#define THREAD_REG23 1340 /* offsetof(struct task_struct, thread.reg23) */
#define THREAD_REG29 1344 /* offsetof(struct task_struct, thread.reg29) */
#define THREAD_REG30 1348 /* offsetof(struct task_struct, thread.reg30) */
#define THREAD_REG31 1352 /* offsetof(struct task_struct, thread.reg31) */
#define THREAD_STATUS 1356 /* offsetof(struct task_struct, thread.cp0_status) */
#define THREAD_BVADDR 1696 /* offsetof(struct task_struct, thread.cp0_badvaddr) */
#define THREAD_BUADDR 1700 /* offsetof(struct task_struct, thread.cp0_baduaddr) */
#define THREAD_ECODE 1704 /* offsetof(struct task_struct, thread.error_code) */
#define THREAD_TRAPNO 1708 /* offsetof(struct task_struct, thread.trap_nr) */

#define THREAD_FPU 1360 /* offsetof(struct task_struct, thread.fpu) */
#define THREAD_FPR0 1360 /* offsetof(struct task_struct, thread.fpu.fpr[0]) */
#define THREAD_FPR1 1368 /* offsetof(struct task_struct, thread.fpu.fpr[1]) */
#define THREAD_FPR2 1376 /* offsetof(struct task_struct, thread.fpu.fpr[2]) */
#define THREAD_FPR3 1384 /* offsetof(struct task_struct, thread.fpu.fpr[3]) */
#define THREAD_FPR4 1392 /* offsetof(struct task_struct, thread.fpu.fpr[4]) */
#define THREAD_FPR5 1400 /* offsetof(struct task_struct, thread.fpu.fpr[5]) */
#define THREAD_FPR6 1408 /* offsetof(struct task_struct, thread.fpu.fpr[6]) */
#define THREAD_FPR7 1416 /* offsetof(struct task_struct, thread.fpu.fpr[7]) */
#define THREAD_FPR8 1424 /* offsetof(struct task_struct, thread.fpu.fpr[8]) */
#define THREAD_FPR9 1432 /* offsetof(struct task_struct, thread.fpu.fpr[9]) */
#define THREAD_FPR10 1440 /* offsetof(struct task_struct, thread.fpu.fpr[10]) */
#define THREAD_FPR11 1448 /* offsetof(struct task_struct, thread.fpu.fpr[11]) */
#define THREAD_FPR12 1456 /* offsetof(struct task_struct, thread.fpu.fpr[12]) */
#define THREAD_FPR13 1464 /* offsetof(struct task_struct, thread.fpu.fpr[13]) */
#define THREAD_FPR14 1472 /* offsetof(struct task_struct, thread.fpu.fpr[14]) */
#define THREAD_FPR15 1480 /* offsetof(struct task_struct, thread.fpu.fpr[15]) */
#define THREAD_FPR16 1488 /* offsetof(struct task_struct, thread.fpu.fpr[16]) */
#define THREAD_FPR17 1496 /* offsetof(struct task_struct, thread.fpu.fpr[17]) */
#define THREAD_FPR18 1504 /* offsetof(struct task_struct, thread.fpu.fpr[18]) */
#define THREAD_FPR19 1512 /* offsetof(struct task_struct, thread.fpu.fpr[19]) */
#define THREAD_FPR20 1520 /* offsetof(struct task_struct, thread.fpu.fpr[20]) */
#define THREAD_FPR21 1528 /* offsetof(struct task_struct, thread.fpu.fpr[21]) */
#define THREAD_FPR22 1536 /* offsetof(struct task_struct, thread.fpu.fpr[22]) */
#define THREAD_FPR23 1544 /* offsetof(struct task_struct, thread.fpu.fpr[23]) */
#define THREAD_FPR24 1552 /* offsetof(struct task_struct, thread.fpu.fpr[24]) */
#define THREAD_FPR25 1560 /* offsetof(struct task_struct, thread.fpu.fpr[25]) */
#define THREAD_FPR26 1568 /* offsetof(struct task_struct, thread.fpu.fpr[26]) */
#define THREAD_FPR27 1576 /* offsetof(struct task_struct, thread.fpu.fpr[27]) */
#define THREAD_FPR28 1584 /* offsetof(struct task_struct, thread.fpu.fpr[28]) */
#define THREAD_FPR29 1592 /* offsetof(struct task_struct, thread.fpu.fpr[29]) */
#define THREAD_FPR30 1600 /* offsetof(struct task_struct, thread.fpu.fpr[30]) */
#define THREAD_FPR31 1608 /* offsetof(struct task_struct, thread.fpu.fpr[31]) */
#define THREAD_FCR31 1616 /* offsetof(struct task_struct, thread.fpu.fcr31) */
#define THREAD_MSA_CSR 1620 /* offsetof(struct task_struct, thread.fpu.msacsr) */
